...
const AdminCertificate = () => {
  ...
  const { data, loading, refetch } = useGetHook("admin/certificate/licenses");
    ...
    <>
      <div className="p-6 bg-white min-h-screen m-2">
        <div className="flex items-center justify-between px-4">
          <p className="text-2xl font-semibold">Certification and Licenses</p>
          <button
      ...
      <Modal title={"Add Certification"}>
        <AddCertificate close={() => setShowModal(false)} refetch={refetch} />
      </Modal>
      <View title="View">
        <ViewCertificate
