...
const SubAdmin = () => {
  ...
  const handleDelete = () => {
    ...
    deleteCat(`admin/sub-admin/delete`, payload, `application/json`, onSuccess);
  };
  ...
  return (
    <div className="px-5">
      ...
      <Deactivate title={""} noHead>
        <ReusableModal
          title={`Are you sure you want to delete this ${selected?.name}?`}
          cancelTitle="No, cancel"
